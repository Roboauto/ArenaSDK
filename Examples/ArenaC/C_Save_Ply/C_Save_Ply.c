...
#define FILE_NAME "Images/C_Save_Ply/image.ply"
...
int main()
{
	...
	if (pixelFormat == LUCID_Coord3D_ABCY16 || pixelFormat == PFNC_Coord3D_ABC16)
	{
		// run example
	...
	{
		printf("This example requires camera to be in a 3D image format like Coord3D_ABC16 or Coord3D_ABCY16\n\n");
	}
