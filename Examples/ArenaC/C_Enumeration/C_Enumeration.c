...
AC_ERROR EnumerateDevices()
{
	...
	// update devices
	err = acSystemUpdateDevices(hSystem, TIMEOUT);
	if (err != AC_ERR_SUCCESS)
		return err;
	...
	//    objects. Device information objects provide access to devices' discovery
	//    information. This information is provided without having to create the
	//    device and includes information related to identification and network
	//    settings.
