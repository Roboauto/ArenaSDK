...
#define FILE_NAME "Images/Cpp_Save_Ply/image.ply"
...
int main()
{
	...
	try
	{
		...
		if ((pImage->GetPixelFormat() == Coord3D_ABC16) || (pImage->GetPixelFormat() == Coord3D_ABCY16))
		{
		...
		{
			std::cout << "This example requires the camera to be in a 3D image format like Coord3D_ABC16 or Coord3D_ABCY16\n\n";
		}
