 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemGetInterfaceMacAddress </B> gets the MAC address of a interface
 * on the network, returning it as its raw integer value.
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemGetInterfaceMacAddressStr </B> gets the MAC address of a
 * interface on the network, returning it as a string.
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemUpdateDevicesHasChanged </B> updates the internal list of
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemGetNumDevices </B> retrieves the number of discovered devices.
 * It must be called after updating the internal list of devices
 ...
 * device. Vendor names differentiate between device vendors/manufacturers.
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acDeviceGetDeviceSerial </B> gets the serial number of a device. A
 * serial number differentiates between devices. Each Lucid device has a unique
 * serial number. Lucid serial numbers are numeric, but the serial numbers of
 * other vendors may be alphanumeric.
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemGetDeviceIpAddressStr </B> gets the IP address of a device on
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSystemDestroyDevice </B> destroys and cleans up the internal memory of
 * a device (acDevice). Devices that have been created (acSystemCreateDevice)
 * must be destroyed.
 *
 * @see 
 *  - acDevice 
