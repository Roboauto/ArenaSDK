 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acImageGetBitsPerPixel </B> gets the number of bits per pixel of the
 * image from the integer value of the pixel format (PfncFormat). Internally, a
 * public helper funciton is called (acGetBitsPerPixel).
 *
 * @see 
 *  - acGetBitsPerPixel
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acImageGetTimestamp </B> gets the timestamp of the image in
 * milliseconds. Images are self-describing, so the device does not need to be
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acImageGetTimestampNs </B> gets the timestamp of the image in
 * nanoseconds. Images are self-describing, so the device does not need to be
 * queried to get this information.
 */
