 ...
 * float, either by floating point, scientific notation, or both depending on
 * the value (automatic).
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acFloatGetDisplayPrecision </B> retrieves the floating point precision
 * of the value.
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acFloatImposeMin </B> imposes a minimum. New minimum must be greater
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acFloatImposeMax </B> imposes a maximum. New maximum must be less than
 * the actual maximum.
 */
