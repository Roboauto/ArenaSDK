 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetNodeAndAccessMode </B> retrieves a node with its access
 * mode.
 */
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetNode </B> tries to lock the node map, returning whether or
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetNode </B> retrieves a node by its index along with its
 * access mode.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetIntegerValue </B> acts as a shortcut for retrieving the
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetFloatValue </B> acts as a shortcut for retrieving the value
 * of a float node.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapGetBooleanValue </B> acts as a shortcut for retrieving the
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapSetStringValue </B> acts as a shortcut for setting the value of
 * a string node.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapSetIntegerValue </B> acts as a shortcut for setting the value
 * of an integer node.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapSetFloatValue </B> acts as a shortcut for setting the value of
 * a float node.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapSetBooleanValue </B> acts as a shortcut for setting the value
 * of a boolean node.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> acNodeMapSetEnumerationValue </B> acts as a shortcut for setting the
 * value of an enumeration node.
 */
