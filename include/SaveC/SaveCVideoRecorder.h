...
/**
 * @fn SC_ERROR SC_API saveRecorderCreate(size_t width, size_t height, size_t fpsDividend, size_t fpsDivisor, saveRecorder* hRecorder)
 *
 * @param width
 *  - Type: size_t 
 *  - [In] parameter 
 ...
 *  - Type: size_t 
 *  - [In] parameter 
 *  - Dividend of the number of frames per second, as expressed as a rational
 *    number
 *
 * @param fpsDivisor
 *  - Type: size_t 
 *  - [In] parameter 
 *  - Divisor of hte number of frames per second, as expressed as a rational
 *    number 
 *  - Cannot be 0
 *
 * @param hRecorder
 ...
 * pixel format is BGR8.
 */
SC_ERROR SC_API saveRecorderCreate(size_t width, size_t height, size_t fpsDividend, size_t fpsDivisor, saveRecorder* hRecorder);
...
/**
 * @fn SC_ERROR SC_API saveRecorderSetParams(saveRecorder hRecorder, size_t width, size_t height, size_t fpsDividend, size_t fpsDivisor)
 *
 * @param hRecorder
 *  - Type: saveRecorder 
 *  - [In] parameter 
 ...
 *  - Type: size_t 
 *  - [In] parameter 
 *  - Divisor of the number of frames per second, as expressed as a rational
 *    number 
 *  - Cannot be 0
 *
 * @return 
 ...
 *  - cannot be called while recording
 */
SC_ERROR SC_API saveRecorderSetParams(saveRecorder hRecorder, size_t width, size_t height, size_t fpsDividend, size_t fpsDivisor);
...
/**
 * @fn SC_ERROR SC_API saveRecorderGetParams(saveRecorder hRecorder, size_t* pWidth, size_t* pHeight, size_t* pFpsDivisor, size_t* pFpsDividend)
 *
 * @param hRecorder
 *  - Type: saveRecorder 
 *  - [In] parameter 
 ...
 */
SC_ERROR SC_API saveRecorderGetParams(saveRecorder hRecorder, size_t* pWidth, size_t* pHeight, size_t* pFpsDividend, size_t* pFpsDivisor);

/**
 * @fn SC_ERROR SC_API saveRecorderGetFPS(saveRecorder hRecorder, double* pFramesPerSecond)
 *
 * @param hRecorder
 *  - Type: saveRecorder 
 *  - [In] parameter 
 ...
 *  - Type: double* 
 *  - [Out] parameter 
 *  - The number of frames per second, as calculated by dividing the FPS
 *    dividend by the FPS divisor
 *
 * @return 
 *  - Type: SC_ERROR 
 *  - Error code for the function 
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveRecorderGetFPS </B> retrieves the frames per second as a double, as
 * calculated by dividing the FPS dividend by the FPS divisor of the video
 * parameters.
 */
SC_ERROR SC_API saveRecorderGetFPS(saveRecorder hRecorder, double* pFramesPerSecond);
