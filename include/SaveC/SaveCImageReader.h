 ...
 *
 * <B> saveReaderCreate </B> initializes an image reader and loads an image.
 * The image reader must be destroyed or memory will leak. This image reader
 * loads images starting from the upper leftmost pixel.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveReaderCreateBottomToTop </B> initializes an image reader and loads
 * an image. The image reader must be destroyed or memory will leak. This image
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveReaderGetData </B> retrieves a pointer to the beginning of the
 * loaded image data. Data must be copied manually in order to retain data
 * beyond beyond the life cycle of the image reader.
 *
 * @warning 
