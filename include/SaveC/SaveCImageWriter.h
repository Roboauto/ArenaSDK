 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterCreate </B> creates an image writer while setting the
 * parameters of the upcoming image(s) to save. The default file name pattern
 * is 'savedimages/image<count>.jpg' and the default file format is jpeg.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterSetRaw </B> changes the image writer to save images as raw
 * data. It also switches the extension to '.raw'.
 */
 ...
 * to save images. Include '<count>' to include an image count (specific to
 * this image image writer). Include '<timestamp>' to include a timestamp. An
 * image's timestamp must be updated manually.
 */
 ...
 *  - none
 *
 * <B> saveWriterUpdateTag </B> updates the value to replace a given tag when
 * an image is saved.
 */
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterPeekFileName </B> peeks at the next file name to use,
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterPeekCount </B> peeks at the count/index of the next saved
 * image particular to the image writer. This is the number that the <count> or
 ...
 *
 * <B> saveWriterPeekCount </B> peeks at the count/index of the next saved
 * image particular to the file name pattern. This is the number that the
 ...
 *
 * <B> saveWriterPeekCount </B> peeks at the count/index of the next saved
 * image across all image writers and video recorders. This is the number that
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterGetLastFileName </B> retrieves the last file name used to save
 ...
 *  - Returns SC_ERR_SUCCESS (0) on success
 *
 * <B> saveWriterSave </B> saves an image starting from the upper leftmost
 * pixel.
 */
