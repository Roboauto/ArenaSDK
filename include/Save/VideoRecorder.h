...
namespace Save
{
	 ...
	 * @class VideoRecorder
	 *
	 * The video recorder facilitates the grouping of image data into video files.
	 */
	...
	public:
		 ...
		 *  - none
		 *
		 * <B> SetRaw </B> sets the recorder to write raw frames with no container or
		 * metadata. Frame data can be written for any pixel format, but data cannot
		 * be played back. It will also set the file extension to '.raw'.
		 *
		 * @warning 
		 ...
		 *  - none
		 *
		 * <B> SetRawAviBGR8 </B> sets the codec to raw, the container to AVI, and
		 * the expected pixel format to BGR8. It will also set the file extension to
		 * '.avi'.
		 *
		 * @warning 
		 ...
		 *  - none
		 *
		 * <B> SetRawMovRGB8 </B> sets the codec to raw, the container to MOV, and
		 * the expected pixel format to RGB8. It will also set the file extension to
		 * '.mov'.
		 *
		 * @warning 
		...
		/**
		 * @fn virtual void SetH264MovRGB8()
		 *
		 * @return 
		 *  - none
		 *
		 * <B> SetH264MovRGB8 </B> sets the codec to H264, the container to MOV, and
		 * the expected pixel format to RGB8. It will also set the file extension to
		 * '.mov'.
		 *
		 * @warning 
		 ...
		 *  - cannot be called while recording
		 */
		virtual void SetH264MovRGB8();

		/**
		 * @fn virtual void SetH264MovBGR8()
		 *
		 * @return 
		 *  - none
		 *
		 * <B> SetH264MovBGR8 </B> sets the codec to H264, the container to MOV, and
		 * the expected pixel format to BGR8. It will also set the file extension to
		 * '.mov'.
		 *
		 * @warning 
		 ...
		 *  - cannot be called while recording
		 */
		virtual void SetH264MovBGR8();

		/**
		 * @fn virtual void SetH264Mp4RGB8()
		 *
		 * @return 
		 *  - none
		 *
		 * <B> SetH264Mp4RGB8 </B> sets the codec to H264, the container to MP4, and
		 * the expected pixel format to RGB8. It will also set the file extension to
		 * '.mp4'.
		 *
		 * @warning 
		 ...
		 *  - cannot be called while recording
		 */
		virtual void SetH264Mp4RGB8();

		/**
		 * @fn virtual void SetH264Mp4BGR8()
		 *
		 * @return 
		 *  - none
		 *
		 * <B> SetH264Mp4BGR8 </B> sets the codec to H264, the container to MP4, and
		 * the expected pixel format to BGR8. It will also set the file extension to
		 * '.mp4'.
		 *
		 * @warning 
		 ...
		 *  - none
		 *
		 * <B> SetParams </B> sets the width and height of the input frame data and
		 ...
		 *  - Video parameters
		 *
		 * <B> GetParams </B> retrieves the video parameters object, which houses the
		 * width, height, and frames per second of the video.
		 */
		 ...
		 *  - The path
		 *
		 * <B> GetPath </B> retrieves the path that the video recorder is currently
		 * outputting videos to.
		 */
		 ...
		 * @return 
		 *  - Type: uint64_t 
		 *  - Pixel format, as defined in the PFNC (Pixel Format Naming Convention)
		 *
		 * <B> GetPixelFormat </B> retrieves the integer value representation of the
		 * pixel format that the recorder is currently expecting.
		 */
		 ...
		 *
		 * <B> PeekFileName </B> retrieves a peek at the file name of the next video
		 * to be recorded, barring any changes to the file name pattern.
		 */
		 ...
		 *  - The last file name
		 *
		 * <B> GetLastFileName </B> retrieves the last file name used for a video.
		 */
		 ...
		 * contexts, and settings, and allocates memory to prepare to append input
		 * frames.
		 *
		 * @warning 
		 ...
		 *  - none
		 *
		 * <B> AppendImage </B> accepts the next frame's raw image data, encodes it,
		 * and appends it to the video file.
		 */
		 ...
		 *  - none
		 *
		 * <B> Close </B> cleans up memory and settings of the video, concluding the
		 * currently recorded video.
		 *
		 * @warning 
